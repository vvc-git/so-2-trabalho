...
{
  db<SiFive_U_NIC>(TRC) << "SiFive_U_NIC::reset(): IMR_before=" << hex << reg(IMR) << endl;
  ...
  db<SiFive_U_NIC>(TRC) << "SiFive_U_NIC::reset: SPADDR1H=" << hex
                        << reg(SPADDR1H) << endl;
  db<SiFive_U_NIC>(TRC) << "SiFive_U_NIC::reset(): IMR_after=" << hex << reg(IMR) << endl;
}
