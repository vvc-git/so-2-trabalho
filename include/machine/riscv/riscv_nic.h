...
private:
  // Buffer config
  static const unsigned int RX_NO_WRAP_SIZE = 0;
  static const unsigned int RX_BUFFER_SIZE =
      (RX_NO_WRAP_SIZE + 16 + 1522 + 3) & ~3;
  static const unsigned int TX_BUFFER_SIZE = (sizeof(Frame) + 3) & ~3;
  static const unsigned int TX_BUFS = 0;

  // Size of the DMA Buffer
  static const unsigned int DMA_BUFFER_SIZE =
      RX_BUFFER_SIZE + TX_BUFFER_SIZE * TX_BUFS;
